// 1. Abstracción: Definir una clase(plantilla) de una figura geometrica
...
class Figura{
    ...
    calcularArea(){
        throw new Error("El método no ha sido implemeentado.")
...
//2. Herencia: Creamos subclases especiales especificas a partir de la clase padre
...
const miTriangulo = new Triangulo("Rosa")
